...
var BeerDetailComponent = (function () {
    ...
    BeerDetailComponent.prototype.dateToString = function (date) {
...
var LocationDetailComponent = (function () {
    ...
    LocationDetailComponent.prototype.dateToString = function (date) {
        return new Date(date).toLocaleDateString();
    };
